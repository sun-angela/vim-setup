...
## Setup
1. Download VS Code
2. From VS Code, download the extensions for VSCodeVim, Tabout, and PDF Viewer by Mathematic Inc.
...
8. Restart VS Code
9. VIOLA! You can now build LaTeX documents on save or by pressing Space+l+b, tabbing out of bracket/quote delimeters, open the corresponding PDF of the active LaTeX file using Space+l+v, navigate and manipulate .tex files with Vim, and most importantly, use snippets
