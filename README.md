...
8. Restart VS Code
9. VIOLA! You can now build LaTeX documents on save or by pressing Space+l+b, open the corresponding PDF of the active LaTeX file using Space+l+v, navigate and manipulate .tex files with Vim, and most importantly, use snippets
